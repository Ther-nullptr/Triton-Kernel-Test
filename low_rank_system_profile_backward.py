...
if __name__ == '__main__':
    ...
    with profile(activities=[ProfilerActivity.CPU, ProfilerActivity.CUDA]) as prof2:
        for _ in range(100):
            ...
            x_new = low_rank_addition_fuse_decompression_dequantization(L_x, R_x, q, o, scale, quantize_bit=2, outlier = outlier_val)
            # backward
            _, _, _ = compute_lora_gradient(dy, x_new, w_bf16, L, R)

    # print(q)
    prof2.export_chrome_trace("trace3_A800_2bit_backward.json")
